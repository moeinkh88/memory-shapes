...
ax.plot(t, M_exp, label='Exponential Decay (Eq 4)', lw=2.5, color='#1f77b4')
ax.plot(t, M_shift, label='Shifted Heaviside (Eq 5)', lw=2.5, color='#ff7f0e')
ax.plot(t, M_bandpass, label='Bandpass Heaviside (Eq 6)', lw=2.5, color='#2ca02c', linestyle='--')
ax.plot(t, M_gamma, label='Gamma Distribution (Eq 7)', lw=2.5, color='#d62728', linestyle=':')
ax.plot(t, M_powerlaw, label='Power-Law (Eq 8)', lw=2.5, color='#9467bd')
